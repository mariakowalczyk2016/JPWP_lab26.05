...
public class Zadanie2 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        topButton.setOnAction(e -> {
            filling = filling + 0.25;
            progressCircle.setProgress(filling);
            if (progressCircle.getProgress() == 1) {
                topButton.setVisible(false);
                buttonGgWp.setText("GG WP");
                setting.setCenter(buttonGgWp);
            }
        });
